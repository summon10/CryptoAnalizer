...
public class crypto {
    ...
    private static final String DEFAULT_PATH_TO_DECRYPTED_BY_STAT = "D:\\crypto\\decrypted_by_stat.txt";
    ...
    private static String strPathToDecryptedByStat = DEFAULT_PATH_TO_DECRYPTED_BY_STAT;
